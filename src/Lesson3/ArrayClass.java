...
//            System.out.println(randomPassword(myRandom(inputIntDataUser("Введите число min > "),
//                    inputIntDataUser("Введите число max > ")))); // усложненный пример со сканером
//        }
...
//        }
      ...
      String[] testArrayString1 = {"Boris", "Anna", "zeBrubis"}; //явное объевление массива
      String[][] testArrayString2 = {{"Boris", "Anna"},
                                    {"zeBrubis", "Elizaveta"}}; //явное объевление массива
